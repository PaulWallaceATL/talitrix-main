          ...
          <div className="px-6 pb-6 flex flex-col gap-4 border-t border-primary/30">
            <label className="flex flex-col gap-2 mt-4">
              ...
              <textarea
                ...
                placeholder={`What is this article about? Be specific.\n\nExample: "We just signed a 3-county pilot in Georgia covering 1,200 pretrial participants. Lead with the policy implications. Mention the T-Band's 20Hz skin-detection. Don't name the counties."`}
              />
