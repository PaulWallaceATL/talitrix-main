...
import NewsroomWizard from "./NewsroomWizard";
    ...
    <div className="px-6 py-8 md:px-12 md:py-12 max-w-6xl">
      <header className="mb-8 md:mb-10 flex flex-wrap items-end justify-between gap-5 md:gap-6">
        <div>
          ...
          <h1 className="text-3xl sm:text-4xl mt-2">Articles</h1>
      ...
      {!envError && articles.length === 0 ? (
        ...
        <>
          <div className="hidden md:block rounded-2xl border border-border-gray overflow-hidden">
          ...
          <ul className="md:hidden flex flex-col gap-4">
            {articles.map((a) => (
              <li
                key={a.id}
                className="rounded-2xl border border-border-gray bg-white/[0.02] p-5 flex flex-col gap-3"
              >
                <div className="flex flex-col gap-1">
                  <span className="text-white text-base flex items-center gap-2 flex-wrap">
                    {a.title}
                    {a.featured && (
                ...
                <div className="flex flex-wrap items-center gap-4 border-t border-border-gray pt-3">
                  <Link
                    href={`/news/${a.slug}`}
                    target="_blank"
