...
const Hero = () => {
  return (
    <div className="relative w-full h-screen flex items-center">
      ...
      />
      <div className="px-6 text-center max-h-190 pt-12 sm:pt-16 pb-12 sm:pb-16 mt-16 sm:mt-24 flex flex-col gap-16 sm:gap-24 lg:gap-36 justify-between h-full items-center w-full">
