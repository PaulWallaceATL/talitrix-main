...
export const metadata: Metadata = {
  ...
  description:
    "Talitrix for Participants — a wrist-worn T-Band designed for dignity and a Participant App for proactive support, clear communication, and a pathway to success.",
};
        ...
        <div className="relative z-10 grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-16">
          ...
          <div className="lg:col-span-7 flex flex-col gap-6 md:gap-8">
            <p className="text-base sm:text-lg text-white/75 leading-relaxed">
              ...
              T-Band is designed to be worn without broadcasting justice
