...
export const ORGANIZATION_JSON_LD = (siteUrl: string) => ({
  ...
  description:
    "Talitrix builds the T-Band — the first independent wrist-worn GPS supervision device — and the Talitrix ONE platform for sheriffs, departments of corrections, courts, and pretrial supervision.",
  sameAs: [],
});
